...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-02-2023 a las 13:15:16
...
(5, '2023_02_02_115606_create_carts_table', 1),
(6, '2023_02_02_125402_create_categories_table', 1),
...
(12, '2023_02_02_122733_create_products_table', 1);
...
CREATE TABLE `orders` (
  ...
  `pago` enum('Credit card','Bizum','PayPal') NOT NULL,
...
CREATE TABLE `products` (
  ...
  `fotosProd` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT json_array() CHECK (json_valid(`fotosProd`)),
...
(1, 'userAdmin', 'userAdmin@gmail.com', '0000-00-00 00:00:00', 'admin', 'admin', 'NULL', '2023-02-04 11:34:33', '2023-02-04 11:34:33');
